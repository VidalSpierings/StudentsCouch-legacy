...
public class FcmNotificationBuilder {
    ...
    public FcmNotificationBuilder person_name(String person_name) {
        mPersoName = person_name;
        return this;
    }
    ...
    private JSONObject getValidJsonBody() throws JSONException {
        ...
        jsonObjectData.put(KEY_PERSON_NAME, mPersoName);
        jsonObjectData.put(KEY_UID, mUid);
        jsonObjectData.put(KEY_FCM_TOKEN, mFirebaseToken);
        jsonObjectBody.put(KEY_DATA, jsonObjectData);

        // retrieve message along with metadata from DB
